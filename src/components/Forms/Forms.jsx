...
const FormAddNewTask = props => {
	...
	return (
		<form onSubmit={handleSubmit} className={css.form}>
			...
			<textarea className={(css.input, css.textarea)} id='taskDescription' name='description' placeholder='Enter task description' value={values.description} onChange={handleChange} />
